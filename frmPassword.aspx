...
&nbsp;<br />
        <br />
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/adding.aspx">
            <asp:Image ID="Image1" runat="server" Height="40px" 
            ImageUrl="~/photogallery/مصروفات.png" Width="120px" />
            <asp:Label ID="Label7" runat="server" Text="Expenses"></asp:Label>
        </asp:HyperLink>
        <br />
        <br />
        <table align="center" bgcolor="#99CCFF" cellpadding="5" class="style1" 
            frame="box" rules="groups" title="كلمة المرور">
            <tr>
                <td class="style7">
                    &nbsp;</td>
                <td class="style3">
