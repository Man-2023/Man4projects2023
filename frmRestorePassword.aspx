<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRestorePassword.aspx.vb" Inherits="password" Culture="af-ZA" %>
...
&nbsp;<br />
        ...
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="14pt" 
            Font-Underline="True" Text="اعادة العمليات المحذوفة"></asp:Label>
        <br />
        <br />
        <br />
        <table align="center" bgcolor="#669900" cellpadding="5" class="style1" 
