<%@ Page Language="VB" AutoEventWireup="false" EnableEventValidation="false" CodeFile="frmIncRep.aspx.vb" Inherits="Default2" Debug="true" %>
...
<body>
    <form id="form1" runat="server" dir="rtl" style="background-color: #996600" 
    title="مان للمشروعات">
    <div style="direction: rtl; background-color: #FFCC99; position: inherit; list-style-type: circle; " 
        ...
        <asp:Panel ID="PanelGridView" runat="server"
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                ...
                <asp:ListItem>نقداً/بشيك</asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" Width="800px"  
            ...
            DataKeyNames="IDD" dir="rtl" EnableTheming="True" Font-Size="Medium" 
...
<RowStyle Width="10%" Font-Size="Medium"></RowStyle>
            <Columns>
                <asp:BoundField DataField="idd" HeaderStyle-Width="2%" ItemStyle-Width="2%"
            FooterStyle-Width="2%" HeaderText="IDD" ApplyFormatInEditMode="True" 
                    ReadOnly="True" >
                    <ControlStyle Width="100%" BackColor="White" ForeColor="White" />
<FooterStyle Wrap="False" Width="7%"></FooterStyle>

<HeaderStyle Wrap="False" Width="7%" BackColor="#FFCCFF" ForeColor="#0000CC"></HeaderStyle>
...
<ItemStyle Wrap="False" Width="10%"></ItemStyle>
                ...
                <asp:BoundField DataField="eType" HeaderStyle-Width="2%" ItemStyle-Width="2%"
            FooterStyle-Width="2%" HeaderText="نقداً/بشيك" SortExpression="eType" >
                    <ControlStyle Width="100%" />
<FooterStyle Wrap="False"></FooterStyle>
...
<ItemStyle Width="2%"></ItemStyle>
            ...
            <HeaderStyle BackColor="#FFCCFF" Font-Bold="True" ForeColor="Black" 
