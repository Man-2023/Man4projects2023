...
Partial Class delOperation
    ...
    Protected Sub ButtonSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSearch.Click
        ...
        If dataReader.HasRows = True Then
            If MsgBox(" هل ترغب فى خذف العملية؟ " + txtSearch.Text.ToString, 528387, "رسالة تأكيد") = 6 Then
                sqlString = ""
                ...
                '------------------------------- اضافة جميع سجلات العملية للملف الاحتياطى

                sqlCommand1.CommandText = "INSERT INTO " & Server.MapPath("app_data\Manold.accdb") & ".masrofat select * from masrofat where  operation =  " & "'" & txtSearch.Text.ToString & "'"
                sqlCommand1.ExecuteNonQuery()
                '-------------------------------  مسح العملية من الملف الاصلى
                ...
                sqlConnection.Close()
                MsgBox("   تم مسح العملية من الملفات! " + txtSearch.Text.ToString, 65536, "  ")
                txtSearch.Text = ""
            Else
                txtSearch.Text = ""
            End If
