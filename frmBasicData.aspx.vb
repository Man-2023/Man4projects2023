...
Class Default2
    ...
    Function GetManData(ByVal sortBy As String) As System.Data.OleDb.OleDbDataReader
        ...
        Select Case DropDownList1.SelectedIndex
            ...
            Case Is = 3
                sqlString = " SELECT * FROM masrofat where wasf = ?   ORDER By " & sortBy
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'InsertCommand = "INSERT INTO [masrofat] ([ID],  [kima], [wasf], [item], [subitem], [operation], [sarf], [notes], [color]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    ...
    Protected Sub GridView1_Update(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        Dim cmd As New OleDbCommand("UPDATE [masrofat] SET [date] = ?, [kima] = ?, [wasf] = ?, [item] = ?, [subitem] = ?, [operation] = ?, [sarf] = ?, [notes] = ? WHERE [ID] =?", cn)
    ...
    Protected Sub ButtonGroup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonGroup.Click
        ...
        Select Case DropDownList1.SelectedIndex
            Case Is = 3
                sqlString = " SELECT count(ID), wasf FROM masrofat where wasf like ? GROUP BY " & " wasf" & " order by " & " wasf"
