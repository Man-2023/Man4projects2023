<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmIncom.aspx.vb" Inherits="adding" EnableEventValidation="False" %>
...
<body>
    ...
    <form id="form1"  runat="server" xml:lang="zh">
    <div align="center">
   <asp:Button ID="btnSave" runat="server" Text="حفظ" style="  z-index : 501;  POSITION: absolute; TOP: 0px; left:14%; width: 6%; height: 20px; right: 872px;" 
            Font-Size="9pt" Font-Names="Arabic Transparent" dir="rtl" Font-Bold="True" TabIndex="7" 
            Height="17px" Visible="False" />
   <asp:Button ID="btnExit" runat="server" Text="خروج" style="  z-index : 501;  POSITION: absolute; TOP: 0px; left:2%; width: 6%; height: 20px; bottom: 574px;" 
            Font-Size="9pt" Font-Names="Arabic Transparent" dir="rtl" Font-Bold="True" TabIndex="9" 
            PostBackUrl="Default.aspx" />  
    
   <asp:Button ID="btnPrint" runat="server" Text="طباعة" style="  z-index : 501;  POSITION: absolute; TOP: 0px; left:8%; width: 6%; height: 20px; " 
            Font-Size="9pt" Font-Names="Arabic Transparent" 
            dir="rtl" Font-Bold="True" TabIndex="8" 
            Visible="False" />
     <asp:Button ID="ButtonDel" runat="server" Text=" حذف "  
            style="  z-index : 501;  POSITION:  absolute; TOP: 0px; left:20%; width: 6%; height: 20px; bottom: 574px;" 
        ...
        <asp:Label ID="lblTitle" runat="server" BackColor="#FFCC66" 
            ...
            Text="أدخال البيانات" Width="20%"></asp:Label>

         <br />
         
            <asp:Button ID="btnTotal0" runat="server" Font-Bold="True" Font-Italic="False" 
                style="POSITION: absolute; TOP: 53px; left: 1%; height: 26px;" Width="18%"
         ...
         <asp:TextBox ID="dateTxtBox" runat="server" Height="20px" dir="rtl"
            ...
            Font-Bold="True" Font-Names="Simplified Arabic"></asp:TextBox>
...
<asp:Button ID="btnAddNewDay" style="  z-index : 501;  POSITION: absolute; TOP: 0px; left:90%; width: 6%; height: 20px;" 
 ...
 <div style =" height:30px; width: 64.9%;" dir="rtl" >
 <asp:Panel ID="Panel2" runat="server" Visible="False" 
         style="  z-index : 501;  POSITION: absolute; left:25%; top: 75px; width: 60%;">
   <table cellspacing="0" cellpadding = "0" rules="all" border="1" id="tblHeader"
        style="font-family:Arial;font-size:15px; color: #FFFFFF;left:15%;
        border-collapse:collapse;height:88%; font-weight: bolder; width: 100%;"  >
    <tr style="background-color: #FFCC66; color: #000000;">
       <td style ="text-align:center; width:5%" >م</td>
       <td style ="width:23%;text-align:center">القيمة</td>
       <td style ="width:23%;text-align:center">الوصف</td>
       <td style ="width:13%;text-align:center">نقدا / بشيك</td>
       <td style ="width:13%;text-align:center">العملية</td>
       <td style ="width:31%;text-align:center">ملاحظات</td>
    </tr>
    </table> 
     </asp:Panel>   
</div>       
        ...
        <div style ="height:450px; width:60%;   POSITION: absolute; overflow:  auto ; LEFT: 25%;  " >
            
            
            
<asp:GridView ID="GridViewAdd" runat="server" AutoGenerateColumns="False" 
                BorderStyle="None"  
                DataKeyNames="IDD" dir="rtl" EnableTheming="True" Font-Size="10pt" 
                HorizontalAlign="Center"  ShowFooter="True" Font-Bold="True" 
                
                style =" width:100%;  padding: 0px 0px;  POSITION: absolute; overflow:  auto ;   " 
                CellPadding="0">
                <RowStyle BackColor="#FFF7E7" Font-Size="X-Small" ForeColor="#8C4510" 
                    Height="18px" VerticalAlign="Middle" Wrap="false" />
                <Columns>
                    <asp:BoundField DataField="IDD" HeaderText="No">
                    ...
                    <asp:TemplateField HeaderText="القيمة" SortExpression="kima">
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox2" runat="server" Height="16px" Wrap="false" Width="64px" 
                                ontextchanged="TextBox2_TextChanged" Text='<%# Bind("kima") %>' 
                    ...
                    <asp:TemplateField HeaderText="الوصف" SortExpression="wasf">
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox3" runat="server" Width="20%"  Wrap="false" Height="18px" 
                                Text='<%# Bind("wasf") %>' MaxLength="15"></asp:TextBox>
                        </ItemTemplate>
                        <ControlStyle Width="100%" />
                        <HeaderStyle Wrap="False" Width="23%" />
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="نقداً/بشيك" SortExpression="item">
                        <ItemTemplate>
                            <asp:DropDownList ID="cmbetype" runat="server" Height="18px" 
                                SelectedValue='<%# Bind("etype") %>' Width="15%">
                                <asp:ListItem>نقداً</asp:ListItem>
                                <asp:ListItem>بشيك</asp:ListItem>
                            </asp:DropDownList>
                        </ItemTemplate>
                        <ControlStyle Width="100%" />
                        <FooterStyle Wrap="False" />
                    ...
                    <asp:TemplateField HeaderText="العملية" SortExpression="operation">
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox4" runat="server" Height="18px" 
                                Text='<%# Bind("operation") %>' Width="20%" Wrap="false" MaxLength="20"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="ملاحظات" SortExpression="notes">
                        <FooterTemplate>
                            <asp:Button ID="ButtonAdd" runat="server" onclick="ButtonAdd_Click" 
                                Text="اضافة سطر" Width="99%" />
                        
</FooterTemplate>
                        <ItemTemplate>
                            <asp:TextBox ID="TextBox5" runat="server" Height="18px" 
                                Text='<%# Bind("notes") %>' Width="25%" Wrap="False" MaxLength="30"></asp:TextBox>
                        </ItemTemplate>
                        <ControlStyle Width="100%" />
                        <FooterStyle Wrap="False" />
                        <HeaderStyle Wrap="False" Width="33%" />
                        <ItemStyle Wrap="False" />
                    </asp:TemplateField>

                </Columns>
                <FooterStyle BackColor="#FFE2C6" Font-Size="Small" ForeColor="#8C4510" />
                <PagerStyle ForeColor="#8C4510" HorizontalAlign="Center" />
                <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
                <EditRowStyle Width="20%" />
            </asp:GridView>
    </div>
...
<script type="text/javascript">
    ...
    <p>
        ...
        <asp:Label ID="LabelT" runat="server" Text="أيرادات" 
            style="POSITION: absolute; TOP: 327px; left: 82%; height: 56px; width: 112px;" 
